...
window.AdminExpensesReview = {
    ...
    _renderView() {
        ...
        // Bulk actions
        html += '<div id="erBulkBar" style="display:none;margin-bottom:8px;display:flex;align-items:center;gap:8px;padding:8px 12px;background:var(--bg-surface);border:1px solid var(--border-color);border-radius:var(--radius)">' +
    ...
    _exportCsv(expenses) {
        ...
        a.href = url;
        a.download = 'belfort-expenses-' + Utils.today() + '.csv';
        a.click();

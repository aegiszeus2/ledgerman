    ...
    _sections: [
        ...
        },
        {
            ...
            content:
                ...
                '<p>You can change the admin login password from the Settings page. The default password is <code>admin123</code> &mdash; change this immediately for security. You can also set the auto-logout timeout for inactive sessions (default: 30 minutes).</p>' +
